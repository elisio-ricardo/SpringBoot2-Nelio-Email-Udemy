...
public class DBService {
    ...
    public void instantiateTestDataBase() throws ParseException {
        ...
        Cliente cl1 = new Cliente(null, "Maria Silva", "elisioestudos@gmail.com", "3456422356", TipoCliente.PESSOAFISICA, pe.encode("123"));
        Cliente cl2 = new Cliente(null, "Ana costa", "elisiorcsilva@gmail.com", "3456232356", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cl2.addPerfil(Perfil.ADMIN);

        cl1.getTelefones().addAll(Arrays.asList("2432323521", "4123532"));
        cl1.getTelefones().addAll(Arrays.asList("243233321", "4133532"));


        Endereco e1 = new Endereco(null, "Rua flores", "344", "apt 233", "Jardim", "2323235235", cl1, c1);
        Endereco e2 = new Endereco(null, "Rua tutu", "244", "apt 433", "Jardim haha", "23156135235", cl1, c2);
        Endereco e3 = new Endereco(null, "Rua imperador", "224", null, "Jardim haha", "23156135235", cl2, c2);
